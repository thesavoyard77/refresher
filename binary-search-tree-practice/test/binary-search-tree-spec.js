...
describe('Binary Search Tree', () => {
  ...
  it('inserts stricly ascending values down the right', () => {
  ...
  it('inserts stricly descending values down the left', () => {
...
1, 3, 2, 5, 7, 6, 4
  ...
  it('can print nodes in pre-order', () => {
  ...
  it('can print nodes in in-order', () => {
  ...
  it('can print nodes in post-order', () => {
